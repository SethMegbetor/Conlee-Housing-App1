...
//   const flisRounded = Math.floor(flispSubsidy / 1000) * 1000;
...
function InputBoxes() {
  ...
  return (
    <div>
      <div className="both-together">
        <label htmlFor="balanceInput">Month 1:</label>
        <input
          type="text"
          name="input1"
          value={values.input1}
      ...
      <div className="both-together">
        <label htmlFor="balanceInput">Month 2:</label>{" "}
        <input
          type="text"
          name="input2"
          value={values.input2}
      ...
      <div className="both-together">
        <label htmlFor="balanceInput">Month 3:</label>{" "}
        <input
          type="text"
          name="input3"
          value={values.input3}
      ...
      <div className="both-together">
        <label htmlFor="balanceInput">Month 4:</label>{" "}
        <input
          type="text"
          name="input4"
          value={values.input4}
      ...
      <div className="both-together">
        <label htmlFor="balanceInput">Month 5:</label>{" "}
        <input
          type="text"
          name="input5"
          value={values.input5}
      ...
      <div className="both-together">
        <label htmlFor="balanceInput">Month 6:</label>{" "}
        <input
          type="text"
          name="input6"
          value={values.input6}
      ...
      {/* <div className="both-together">
        <label htmlFor="balanceInput">Month 7:</label>{" "}
        <input
          type="text"
          name="input7"
          value={values.input7}
      ...
      <br />
      <br />
      <label htmlFor="balanceInput">Enter your bank amount:</label>
      <input
        type="number"
        id="balanceInput"
        value={inputValue}
      ...
      {clicked && (
        <div>
          ...
          <p>Flisp Subsidy: {flispSubsidy}</p>
          <p>Flisp rounded: {flisp}</p>
          <p>Bank amount: {bankBalanceAmount}</p>
          <p>Markup: {markupAmount}</p>
        </div>
      )}
      <p></p>
      <div className="both-together">
        <br />
        <label htmlFor="clientInput">Client name: </label>
        <input
          type="text"
          id="clientName"
          value={clientValue}
      ...
      <div className="both-together">
        {" "}
        <label htmlFor="agentInput">Agent name: </label>
        <input
          type="text"
          id="agentValue"
          value={agentValue}
      ...
      {/* <p>{ finalBuyingPower}</p> */}
      <p>***********</p>
      <p>Client name: {clientValue}</p>
      <p>Collected by: {agentValue}</p>
      <p> Amount from the bank: R{bankBalanceAmount}</p>
      <p>FLISP: R{flisp}</p>
      <p>Buying power: R{finalBuyingPower}</p>{" "}
    </div>
